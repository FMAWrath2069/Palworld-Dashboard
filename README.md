...
```
Unzip the maps.zip folder and put all folders in /maps
---
...
└── servers/
    ├── default/
    │   ├── bases.json      # Cached Palworld base/camp information: locations, player
    |   |                     ownership, coordinates, and other base-related tracking data.
